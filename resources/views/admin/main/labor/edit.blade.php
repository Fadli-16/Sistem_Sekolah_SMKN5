...
<div class="container-fluid">
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted">Ubah informasi laboratorium yang sudah ada</p>
        </div>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="form-card">
                <form action="{{ route('admin.labor.update', $labor->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <div class="form-group">
                        <label for="nama_labor" class="form-label required">Nama Laboratorium</label>
                        <input type="text" class="form-control @error('nama_labor') is-invalid @enderror" id="nama_labor" name="nama_labor" value="{{ old('nama_labor', $labor->nama_labor) }}" required>
                        @error('nama_labor')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('kode') is-invalid @enderror" id="kode" name="kode" value="{{ old('kode', $labor->kode) }}">
                        @error('kode')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
...
<div class="mb-3">
    ...
    <input type="text" name="teknisi" id="teknisi" class="form-control" value="{{ old('teknisi', $labor->teknisi ?? '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi" rows="3">{{ old('deskripsi', $labor->deskripsi) }}</textarea>
                        @error('deskripsi')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
    ...
    @enderror
                    ...
                    <div class="form-group mb-0">
                        ...
                        <a href="{{ route('admin.labor.index') }}" class="btn btn-light">Batal</a>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="col-lg-4">
            <div class="card h-100 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <ul class="mb-0">
                        <li>Perubahan pada kode laboratorium dapat mempengaruhi jadwal yang sudah dibuat</li>
                        <li>Pastikan kode laboratorium tetap unik untuk menghindari konflik</li>
                    </ul>
                </div>
            </div>
        </div>
